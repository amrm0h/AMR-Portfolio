...
const btnClasses = {
  primary: 'border-2 border-mainColor hoverEffect px-5 md:px-32 py-5 text-xl tracking-widest font-bold rounded-md group w-11/12 max-w-sm md:max-w-none md:w-auto',
  default: '',
};
